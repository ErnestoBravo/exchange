...
@Component({
    ...
    templateUrl: './create-modify-loadunit.component.html',
    styleUrls: ['./create-modify-loadunit.component.scss'],
    providers: [LoadUnitService]
})
export class CreateModifyLoadUnitComponent implements OnInit {
